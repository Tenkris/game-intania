...
import userImage from "@/app/assets/hud/hero-logo.webp";
import mailImage from "@/app/assets/hud/mail-logo.webp";
import attackImage from "@/app/assets/hud/attack-logo.webp";
import defenseImage from "@/app/assets/hud/defense-logo.webp";
import hpImage from "@/app/assets/hud/heart-logo.webp";
          ...
          <div className="w-full rounded-xl border border-gray-400 flex flex-col p-3 gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <p>
                  <span className="font-semibold">HP:</span> {userInfo.hp}
                </p>
              </div>
            </div>
          </div>
