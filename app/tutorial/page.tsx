  ...
  const steps = [
    {
      step: 1,
      title: "Game Start",
      description: "The game starts with a question that you need to answer.",
    ...
    },
    {
      ...
      description:
        "If you answer correctly and fast, press the spacebar at the right time to deal critical damage to the boss.",
      image: tutorial2Image,
    },
    {
      step: 3,
      title: "Guarding",
      description: "Press spacebar repeatedly to guard the boss from attacks.",
    ...
    },
    {
      ...
      description:
        "After defeating the boss, choose your gift and proceed to the next question.",
    },
    {
      step: 5,
      title: "Game Over",
      description: "If your health drops to zero, you lose the game.",
    },
  ];
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="card w-11/12 lg:w-2/5 items-center justify-center">
        ...
        <div className="w-full flex justify-between items-center px-4 py-2 text-xs z-30">
          {/* <button
