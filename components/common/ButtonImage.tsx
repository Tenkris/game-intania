...
export default function ButtonImage({ src, alt = "button", children, onClick , type}: { src: string | StaticImageData, alt: string , children: ReactNode | string, onClick?: () => void, type?: "button" | "submit" | "reset" | undefined }) {
    return (
